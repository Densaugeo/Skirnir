...
test/Skirnir180_test: test/Skirnir180_test.cpp src/Skirnir180.cpp src/Skirnir180.hpp test/Skirnir_test test/HardwareSerial_test test/catch.hpp
	$(CXX) $(CXXFLAGS) test/Skirnir180_test.cpp src/Skirnir180.cpp src/Skirnir.cpp src/base64.cpp test/HardwareSerial.cpp -o $@
	./$@
